...
const seedDatabase = async () => {
    try {
        console.log('🌱 Starting focused seeding for Companies, LoanProducts, Banks, and Billers...');
        ...
        if (companyCount > 0 &&
            ...
            bankCount > 0 &&
            billerCount > 0) {
            console.log('Database already contains seed data. Skipping seeding process.');
            return;
        }
            ...
            const loanProducts = [
                {
                    ...
                    features: [
                        ...
                        },
                        {
                            ...
                            description: 'Get a decision within 24-48 hours after complete submission.',
                        },
                        {
                            title: 'No Collateral Required',
                            description: "Unsecured loan option that doesn't require any collateral.",
                        },
                    ],
                    eligibility: [
                    ...
                    faq: [
                        ...
                        },
                        {
                            ...
                            answer: 'We allow early repayment with minimal fees. A fee of 5% of the remaining principal balance will apply.',
                        },
                    ],
                },
                {
                    ...
                    icon: 'home-variant',
                    color: '#059669',
                    description: "Make your dream home a reality with our competitive home loan options. Whether you're buying your first home, refinancing, or investing in property, we have solutions tailored to your needs.",
                    requirements: [
                        'Must be 21-65 years old',
                    ...
                    features: [
                        {
                            ...
                            description: 'Flexible terms from 5 to 30 years to fit your financial situation.',
                        },
                        {
                            title: 'Low Interest Rates',
                            description: 'Competitive interest rates starting from 5.75% per annum.',
                        },
                        {
                            title: 'High Loan Amount',
                            description: 'Borrow up to ₱10,000,000 depending on property value and income.',
                        },
                        {
                            title: 'Multiple Property Types',
                            description: 'Finance single-family homes, condominiums, townhouses, and more.',
                        },
                    ],
                    eligibility: [
                        'Filipino citizen or resident foreigner',
                    ...
                    faq: [
                        {
                            ...
                            answer: 'We offer up to 80% financing of the appraised property value.',
                        },
                        {
                            question: 'Can I apply for a home loan for a property under construction?',
                            answer: 'Yes, we offer construction loans with progressive release of funds based on construction milestones.',
                        },
                    ],
                },
                {
